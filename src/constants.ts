...
<ul class='list-none pl-1 md:pl-5 text-xs md:text-sm' style='color: #409584'>
	...
	<ul class='list-none pl-1 md:pl-5 text-xs md:text-sm'>
		<li class='before:content-['-']' style='color: #ae4f4f'>TV/Movies<span class='text-white'>: Scott Pilgrim vs the World, Shaun of the Dead, Chainsaw Man</span></li>
		<li class='before:content-['-']' style='color: #4fae67'>Video Games<span class='text-white'>: Minecraft, Team Fortress 2, Warframe, Zenless Zone Zero </span></li>
		<li class='before:content-['-']' style='color: #4f6dae'>Artists<span class='text-white'>: Carpenter Brut, Ricky Montgomery, Jerma</span></li>
	</ul>
</ul><br></br>
