...
const AboutBox: React.FC = () => {
    ...
    useEffect(() => {
        ...
        }, 100); // Updates every 500 milliseconds
    ...
    return (
        <div style={{ borderColor: INTERFACE_COLOR }} className='relative border p-4'>
            <div className='relative z-20'>
                ...
                <p>many features planned for this site.</p>
            ...
            <div className='absolute right-0 top-0 flex space-x-4 z-10 '>
                <div
                    ...
                    className='border p-2 h-32 w-64 overflow-hidden font-mono text-gray-500'>
                ...
                <div
                    ...
                    className='border p-2 h-32 w-32 overflow-hidden font-mono text-gray-500 flex items-center justify-center'>
